...
while (True):
    ...
    bil4 = int(input("masukan bilangan ke-4 : "))
    bil5 = int(input("masukan bilangan ke-5 : "))
    ...
    print(bil)
    print('Nilai Maks :',max(bil))
    print('Nilai Min :',min(bil))
    print('Nilai Rata :',sum(bil) / len(bil))
